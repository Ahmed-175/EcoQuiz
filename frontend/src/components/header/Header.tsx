...
const Header = () => {
  ...
  return (
    <div className="fixed  z-30 rounded-b-2xl w-full h-20 flex justify-between items-center px-6 md:px-16">
      {/* LOGO */}
      ...
      <div className="flex-1 flex justify-end">
        {user ? (
          ...
          <Link
            ...
            className="flex items-center gap-2.5 px-4 py-2.5  border border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-sm transition-all duration-300 group"
          >
